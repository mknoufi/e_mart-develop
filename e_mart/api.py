...
def get_series_data():
    ...
    try:
        ...
        frappe.log_error(f"Series data error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def generate_series(series_type):
    ...
    try:
        ...
        frappe.log_error(f"Generate series error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def reset_series(series_type, start_number):
    ...
    try:
        ...
        return {
            "success": True,
            "message": f"{series_type.title()} series reset successfully"
        }
    except Exception as e:
        frappe.log_error(f"Reset series error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def get_purchase_invoices(filters=None):
    ...
    try:
        ...
        frappe.log_error(f"Get purchase invoices error: {str(e)}")
        return {
            "success": False,
            "data": []
        }
...
def create_purchase_invoice(data):
    ...
    try:
        ...
        frappe.log_error(f"Create purchase invoice error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def get_sales_invoices(filters=None):
    ...
    try:
        ...
        frappe.log_error(f"Get sales invoices error: {str(e)}")
        return {
            "success": False,
            "data": []
        }
...
def create_sales_invoice(data):
    ...
    try:
        ...
        frappe.log_error(f"Create sales invoice error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def get_special_schemes():
    ...
    try:
        ...
        frappe.log_error(f"Get special schemes error: {str(e)}")
        return {
            "success": False,
            "data": []
        }
...
def create_special_scheme(data):
    ...
    try:
        ...
        frappe.log_error(f"Create special scheme error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def get_report(report_type, filters=None):
    ...
    try:
        ...
        frappe.log_error(f"Get report error: {str(e)}")
        return {
            "success": False,
            "data": []
        }
...
def mark_notification_read(notification_id):
    ...
    try:
        ...
        frappe.log_error(f"Mark notification read error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def scan_qr_code(qr_data):
    ...
    try:
        ...
        frappe.log_error(f"QR scan error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def get_app_settings():
    ...
    try:
        ...
        frappe.log_error(f"Get app settings error: {str(e)}")
        return {
            "success": False,
            "data": {}
        }
...
def update_app_settings(settings):
    ...
    try:
        ...
        frappe.log_error(f"Update app settings error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
    ...
    try:
        ...
        for data_item in offline_data:
            try:
                ...
                frappe.log_error(f"Sync item error: {str(e)}")
                continue
        ...
        frappe.log_error(f"Sync offline data error: {str(e)}")
        return {
            "success": False,
            "message": str(e)
        }
...
def get_series_count(series_type):
    ...
    try:
        if series_type == "normal":
            return frappe.db.count("Purchase Invoice", filters={
                "purchase_category": "Normal",
                "docstatus": 1
            })
        else:
            return frappe.db.count("Purchase Invoice", filters={
                "purchase_category": "Special",
                "docstatus": 1
            })
    except:
        return 0
